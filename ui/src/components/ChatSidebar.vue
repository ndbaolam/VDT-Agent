  ...
  <aside class="w-80 bg-gradient-to-b from-slate-50 to-white shadow-xl flex flex-col">    
    ...
    <div class="flex-1 overflow-y-auto px-4">
      ...
      <div v-else-if="chatHistory.length === 0" class="text-center py-12">
        <div class="bg-gradient-to-br from-indigo-100 to-purple-100 w-20 h-20 rounded-full mx-auto mb-6 flex items-center justify-center">
        ...
        <p class="text-gray-500 text-sm leading-relaxed">Start your first conversation to<br>see your chat history here</p>
      </div>
      ...
      <div v-else class="space-y-2 pb-4">
        ...
        >
          <div
            ...
            :class="{
              'bg-gradient-to-r from-indigo-50 to-purple-50 border-indigo-200 shadow-md': currentThreadId === chat.thread_id,
              'hover:bg-gradient-to-r hover:from-gray-50 hover:to-slate-50': currentThreadId !== chat.thread_id
            }"
          >
            <!-- Chat Content -->
            <div class="flex items-start gap-3">
              <!-- Chat Icon -->
              <div class="flex-shrink-0 w-10 h-10 rounded-full bg-gradient-to-br from-indigo-400 to-purple-500 flex items-center justify-center shadow-sm">
              ...
              <div class="flex-1 min-w-0">
                ...
                <div class="flex items-center gap-3 mt-2 text-xs">
                  <span v-if="chat.message_count" class="text-indigo-600 bg-indigo-50 px-2 py-1 rounded-lg font-medium">
    ...
    <!-- Elegant Footer -->
    <footer v-if="chatHistory.length > 0" class="p-4 border-t border-gray-100 bg-gradient-to-r from-gray-50 to-slate-50">
